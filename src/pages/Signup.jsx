...
const Signup = () => {
    ...
    const handleSocialSubmit = async (e) => {
        ...
        setTimeout(() => {
            ...
            // Save Social User Details
            const newUser = {
                id: `${socialProvider}-user-` + Date.now(),
                name: `Client (via ${socialProvider})`,
                email: `user@${socialProvider.toLowerCase()}.com`, // Mock email
                phone: socialData.mobile,
            ...
            localStorage.setItem('registeredUsers', JSON.stringify([newUser, ...existingUsers]));

            alert(`Account verified via ${socialProvider}! Please valid login.`);
            navigate('/login');
        }, 1500);
    };
    ...
    return (
        <div className="signup-page">
            ...
            {/* Social Login Validation Modal for Signup */}
            {showSocialModal && (
                <div className="modal-overlay" onClick={() => setShowSocialModal(false)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-header">
                            <h3 className="modal-title">Complete Registration</h3>
                            <p className="signup-subtitle">Verifying details for {socialProvider} Signup</p>
                        </div>

                        <form onSubmit={handleSocialSubmit} className="signup-form">
                            <div className="form-group">
